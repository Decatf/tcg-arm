...
typedef enum {
    ...
    TRACE_GUEST_MEM_BEFORE_TRANS,
    TRACE_GUEST_MEM_BEFORE_EXEC,
    TRACE_GUEST_USER_SYSCALL,
    TRACE_GUEST_USER_SYSCALL_RET,
    TRACE_QEMU_MEMALIGN,
    ...
    TRACE_GIC_ENABLE_IRQ,
    TRACE_GIC_DISABLE_IRQ,
    TRACE_GIC_SET_IRQ,
    TRACE_GIC_UPDATE_BESTIRQ,
    TRACE_GIC_UPDATE_SET_IRQ,
    TRACE_GIC_ACKNOWLEDGE_IRQ,
    TRACE_GICV3_ICC_PMR_READ,
    TRACE_GICV3_ICC_PMR_WRITE,
    TRACE_GICV3_ICC_BPR_READ,
    TRACE_GICV3_ICC_BPR_WRITE,
    TRACE_GICV3_ICC_AP_READ,
    TRACE_GICV3_ICC_AP_WRITE,
    TRACE_GICV3_ICC_IGRPEN_READ,
    TRACE_GICV3_ICC_IGRPEN_WRITE,
    TRACE_GICV3_ICC_IGRPEN1_EL3_READ,
    TRACE_GICV3_ICC_IGRPEN1_EL3_WRITE,
    TRACE_GICV3_ICC_CTLR_READ,
    TRACE_GICV3_ICC_CTLR_WRITE,
    TRACE_GICV3_ICC_CTLR_EL3_READ,
    TRACE_GICV3_ICC_CTLR_EL3_WRITE,
    TRACE_GICV3_CPUIF_UPDATE,
    TRACE_GICV3_CPUIF_SET_IRQS,
    TRACE_GICV3_ICC_GENERATE_SGI,
    TRACE_GICV3_ICC_IAR0_READ,
    TRACE_GICV3_ICC_IAR1_READ,
    TRACE_GICV3_ICC_EOIR_WRITE,
    TRACE_GICV3_ICC_HPPIR0_READ,
    TRACE_GICV3_ICC_HPPIR1_READ,
    TRACE_GICV3_ICC_DIR_WRITE,
    TRACE_GICV3_ICC_RPR_READ,
    TRACE_GICV3_DIST_READ,
    TRACE_GICV3_DIST_BADREAD,
    TRACE_GICV3_DIST_WRITE,
    TRACE_GICV3_DIST_BADWRITE,
    TRACE_GICV3_DIST_SET_IRQ,
    TRACE_GICV3_REDIST_READ,
    TRACE_GICV3_REDIST_BADREAD,
    TRACE_GICV3_REDIST_WRITE,
    TRACE_GICV3_REDIST_BADWRITE,
    TRACE_GICV3_REDIST_SET_IRQ,
    TRACE_GICV3_REDIST_SEND_SGI,
    ...
    TRACE_NET_RX_PKT_L4_CSUM_CALC_PH_CSUM,
    TRACE_NET_RX_PKT_L4_CSUM_CALC_CSUM,
    TRACE_NET_RX_PKT_L4_CSUM_FIX_ENTRY,
    TRACE_NET_RX_PKT_L4_CSUM_FIX_TCP,
    ...
    TRACE_NET_RX_PKT_L4_CSUM_FIX_CSUM,
    ...
    TRACE_E1000X_RX_CAN_RECV_DISABLED,
    TRACE_E1000X_VLAN_IS_VLAN_PKT,
    TRACE_E1000X_RX_FLT_UCAST_MATCH,
    TRACE_E1000X_RX_FLT_UCAST_MISMATCH,
    TRACE_E1000X_RX_FLT_INEXACT_MISMATCH,
    TRACE_E1000X_RX_LINK_DOWN,
    TRACE_E1000X_RX_DISABLED,
    TRACE_E1000X_RX_OVERSIZED,
    TRACE_E1000X_MAC_INDICATE,
    ...
    TRACE_E1000E_LINK_STATUS_CHANGED,
    ...
    TRACE_SPAPR_IOMMU_PRE_SAVE,
    TRACE_SPAPR_IOMMU_POST_LOAD,
    TRACE_SPAPR_IOMMU_DDW_QUERY,
    TRACE_SPAPR_IOMMU_DDW_CREATE,
    TRACE_SPAPR_IOMMU_DDW_REMOVE,
    TRACE_SPAPR_IOMMU_DDW_RESET,
    TRACE_PPC_TB_ADJUST,
    ...
    TRACE_VFIO_INITFN,
    TRACE_VFIO_ADD_EXT_CAP_DROPPED,
    ...
    TRACE_VFIO_PCI_IGD_BAR4_WRITE,
    TRACE_VFIO_PCI_IGD_BDSM_ENABLED,
    TRACE_VFIO_PCI_IGD_OPREGION_ENABLED,
    TRACE_VFIO_PCI_IGD_HOST_BRIDGE_ENABLED,
    TRACE_VFIO_PCI_IGD_LPC_BRIDGE_ENABLED,
    ...
    TRACE_VFIO_REGION_SPARSE_MMAP_ENTRY,
    ...
    TRACE_VFIO_PREREG_REGISTER,
    TRACE_VFIO_PREREG_UNREGISTER,
    TRACE_VFIO_SPAPR_CREATE_WINDOW,
    ...
    TRACE_CPUHP_ACPI_INVALID_IDX_SELECTED,
    TRACE_CPUHP_ACPI_READ_FLAGS,
    TRACE_CPUHP_ACPI_WRITE_IDX,
    TRACE_CPUHP_ACPI_WRITE_CMD,
    TRACE_CPUHP_ACPI_READ_CMD_DATA,
    TRACE_CPUHP_ACPI_CPU_HAS_EVENTS,
    TRACE_CPUHP_ACPI_CLEAR_INSERTING_EVT,
    TRACE_CPUHP_ACPI_CLEAR_REMOVE_EVT,
    TRACE_CPUHP_ACPI_EJECTING_INVALID_CPU,
    TRACE_CPUHP_ACPI_EJECTING_CPU,
    TRACE_CPUHP_ACPI_WRITE_OST_EV,
    TRACE_CPUHP_ACPI_WRITE_OST_STATUS,
    ...
    TRACE_KVM_X86_FIXUP_MSI_ERROR,
    TRACE_KVM_X86_ADD_MSI_ROUTE,
    TRACE_KVM_X86_REMOVE_MSI_ROUTE,
    TRACE_KVM_X86_UPDATE_MSI_ROUTES,
...
typedef enum {
    TRACE_VCPU_GUEST_MEM_BEFORE_TRANS,
    TRACE_VCPU_GUEST_MEM_BEFORE_EXEC,
    TRACE_VCPU_GUEST_USER_SYSCALL,
    TRACE_VCPU_GUEST_USER_SYSCALL_RET,
...
#define TRACE_BDRV_AIO_PDISCARD_ENABLED 1
